...
if (!class_exists('ThemeFarmer_About_Page')) {
	class ThemeFarmer_About_Page {
		...
		function __construct() {
			...
			$this->demo_link  = 'http://demo.themefarmer.com/mega-store/?utm_source=mega-store-dashboard&utm_medium=demo-mega-store&utm_campaign=welcome-page';
			$this->docs_link  = 'http://docs.themefarmer.com/mega-store-documentation/?utm_source=mega-store-dashboard&utm_medium=documentation-mega-store&utm_campaign=welcome-page';
			$this->rate_link  = 'http://wordpress.org/support/view/theme-reviews/mega-store';
			$this->theme_page = 'https://www.themefarmer.com/free-themes/mega-store-e-commerce-wordpress-theme/?utm_source=mega-store-dashboard&utm_medium=details-mega-store&utm_campaign=welcome-page';
			$this->pro_link   = 'https://www.themefarmer.com/product/mega-store-pro/?utm_source=mega-store-dashboard&utm_medium=mega-store-pro-link&utm_campaign=upgrade-to-pro';
